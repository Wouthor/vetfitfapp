...
export default function CompleteButton({ workoutId, completedAt }: CompleteButtonProps) {
  ...
  if (done && date) {
    return (
      <div className="flex items-center gap-2 py-3 px-4 bg-green-900/30 border border-green-800 rounded-xl">
  ...
  return (
    <button
      ...
      disabled={loading}
      className="w-full flex items-center justify-center gap-2 py-3 px-4 bg-green-900/20 border border-green-800/50 hover:bg-green-900/40 text-green-400 font-semibold rounded-xl transition-colors"
    >
